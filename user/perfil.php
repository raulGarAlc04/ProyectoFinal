...
<main class="container" id="content">
    ...
    <div class="profile-section">
        ...
        <div class="profile-actions">
            ...
            <form action="perfil.php" method="post" style="display: inline;" onsubmit="return confirm('¿Estás seguro de que quieres borrar tu cuenta? Esta acción no se puede deshacer.');">
                <input type="hidden" name="borrar_cuenta" value="1">
